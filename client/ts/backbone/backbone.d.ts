...
declare module Backbone {
    ...
    class ModelBase extends Events {
        ...
        sync(method, model, options?: JQueryAjaxSettings): JQueryXHR;
    }
    ...
    class Router extends Events implements OptionalRoutes {
        ...
        route(route: RegExp, name: string, callback?: (...parameter: any[]) => void );
    ...
    // SYNC
    function sync(method, model, options?: JQueryAjaxSettings): JQueryXHR;
