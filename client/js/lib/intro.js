  ...
  */
  ...
  function _showElement(targetElement) {
    ...
    if (this._currentStep == 0 && this._introItems.length > 1) {
      prevTooltipButton.className = 'introjs-button introjs-prevbutton hidden';
      nextTooltipButton.className = 'introjs-button introjs-nextbutton btn btn-primary';
      skipTooltipButton.innerHTML = this._options.skipLabel;
    } else if (this._introItems.length - 1 == this._currentStep || this._introItems.length == 1) {
      skipTooltipButton.innerHTML = this._options.doneLabel;
      prevTooltipButton.className = 'introjs-button introjs-prevbutton btn btn-default';
      nextTooltipButton.className = 'introjs-button introjs-nextbutton hidden';
    } else {
      prevTooltipButton.className = 'introjs-button introjs-prevbutton btn btn-default';
      nextTooltipButton.className = 'introjs-button introjs-nextbutton btn btn-primary';
      skipTooltipButton.innerHTML = this._options.skipLabel;
